...
var _running, _active, _bypassed, _options, _epoch, _synchronizationOffset, _interval;
...
class Timer {
  ...
  async setTimingWorklet(type, processor, audioContext) {
    ...
    try {
      ...
      this.timingWorkHandler = await createTimingWorklet2(audioContext);
...
const timing_audioworklet = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createTimingWorklet,
  default: TimingAudioWorkletNode
